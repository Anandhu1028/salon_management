...
@section('content')
        ...
        <div class="content-card">
                ...
                <div class="content-card-header-actions">
                    ...
                    <form method="GET" action="{{ route('staff.index') }}" class="staff-search">
                        <div class="search-box">
                            ...
                            @endif
                            @if($search)
                                <a href="{{ route('staff.index', array_filter(['filter' => $filter ?? ''])) }}"
                                    title="Clear search">
                                    <i class="bi bi-x"></i>
                                </a>
                            @endif
            ...
            @else
                ...
                <div class="empty-state">
                    ...
                    <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#staffModal"
    ...
    <div class="modal fade premium-modal premium-modal--md" id="staffModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                <form id="staffForm" method="POST" action="{{ route('staff.store') }}">
                        ...
                        <div class="modal-form-grid">
                            ...
                            <div class="form-field">
                                ...
                                <div class="field-control-wrap">
                                    ...
                                    <input type="text" name="name" id="staff_name" class="form-control"
                            ...
                            <div class="form-field">
                                ...
                                <select name="status" id="staff_status" class="form-select" data-icon="bi-shield-check"
                                    required>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="staffSubmitButton">
