...
<div class="service-page management-page">
    ...
    <div class="content-card">
            ...
            <div class="content-card-header-actions">
                <form method="GET" action="{{ route('services.index') }}" class="service-search">
                    <div class="search-box">
                        ...
                        @endif
                        @if($search)
                            <a href="{{ route('services.index', array_filter(['filter' => $filter ?? ''])) }}" title="Clear search">
                                <i class="bi bi-x"></i>
                            </a>
                        @endif
                    </div>
        ...
        @if($services->count())
            ...
            <div class="premium-list premium-list--catalog premium-list--feed premium-list--compact premium-list--mgmt premium-list--service">
        ...
        <div class="modal-content">
            <form id="serviceForm" method="POST" action="{{ route('services.store') }}">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="serviceSubmitButton">Save Service</button>
                </div>
...
function openAddServiceModal() {
    ...
    document.getElementById('serviceSubmitButton').textContent = 'Save Service';
...
function openEditServiceModal(service) {
    ...
    document.getElementById('serviceSubmitButton').textContent = 'Update Service';
