...
<div class="product-page management-page">
    ...
    <div class="content-card">
            ...
            <div class="content-card-header-actions">
                <form method="GET" action="{{ route('products.index') }}" class="product-search">
                    <div class="search-box">
                        ...
                        @endif
                        @if($search)
                            <a href="{{ route('products.index', array_filter(['filter' => $filter ?? ''])) }}" title="Clear search">
                                <i class="bi bi-x"></i>
                            </a>
                        @endif
                    </div>
        ...
        @if($products->count())
            ...
            <div class="premium-list premium-list--catalog premium-list--feed premium-list--compact premium-list--mgmt premium-list--product">
...
<div class="modal fade premium-modal" id="productModal" tabindex="-1" aria-hidden="true">
